...
Codex invokes skills as `$skill-name`. Claude Code's `/skill-name` spelling in source-side documentation is host-specific; do not mechanically rewrite it unless the document is explicitly cross-host.
